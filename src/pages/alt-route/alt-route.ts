...
@Component({
  selector: 'page-alt-route',
  templateUrl: 'alt-route.html'
})
export class AltRoutePage {
  ...
  constructor(public navCtrl: NavController,public params: NavParams,public toastCtrl:ToastController,public platform:Platform, 
  public alertCtrl:AlertController, public busLocationService:BusLocation,public routes_stops_service:RoutesStopsService,
  public viewCtrl:ViewController, public geolocation:Geolocation, public iab: InAppBrowser) {
  ...
  ngOnInit(){
    ...
    //keep track of active pages
    // localStorage.setItem('index',String(this.viewCtrl.index));
    this.loadMap();
